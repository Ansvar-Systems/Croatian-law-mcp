/**
 * Rate-limited HTTP client for Croatian legislation from the Sejm ELI API.
 *
...
const USER_AGENT = 'Croatian-Law-MCP/1.0 (https://github.com/Ansvar-Systems/croatian-law-mcp; hello@ansvar.ai)';
