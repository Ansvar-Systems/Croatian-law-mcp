# Legal Disclaimer / Pravna izjava o odricanju odgovornosti

**READ THIS CAREFULLY BEFORE USING THIS SOFTWARE**
**PAŽLJIVO PROČITAJTE PRIJE KORIŠTENJA OVOG SOFTVERA**

## Not Legal Advice / Nije pravni savjet
...
- **No Attorney-Client Relationship**: Use of this Tool does not create an attorney-client relationship (odnos odvjetnik-klijent)
...
### For Legal Professionals / Za pravne stručnjake
...
- **Professional Rules**: Members of the Hrvatska odvjetnička komora (Croatian Bar Association) must comply with applicable professional conduct rules (Kodeks odvjetničke etike) when using AI tools
- **Client Disclosure**: Consider whether professional ethics rules require disclosing AI tool use to clients

### Duty of Independent Verification / Obveza neovisne provjere
...
1. Checking the official source (Narodne novine / Official Gazette at nn.hr)
2. Verifying the provision is currently in force (na snazi) and has not been amended
3. Reading the full context of cited provisions
4. Consulting case law and preparatory works for interpretation
5. Considering how recent legal developments and EU law harmonization may affect the matter

## Data Authority and Limitations

### Source Authority

This Tool aggregates data from official Croatian legal databases. However:

| Source Type | Authority Level | Use Case |
|------------|----------------|----------|
| **Official government databases** | Authoritative | Statute text (primary reference) |
| **Narodne novine (Official Gazette)** | Authoritative | Promulgated laws, regulations, and decrees |
| **Community/open-data sources** | Supplementary | Case law, cross-references (verify independently) |
| **EUR-Lex / EU treaty databases** | Authoritative for EU law | EU regulations, directives, and obligations |

**CRITICAL**: Community-maintained resources are **NOT** official government publications. While generally reliable, they may contain transcription errors, outdated information, or incomplete coverage. As an **EU Member State**, Croatian law must be interpreted in light of EU directives and regulations.

### Commercial Legal Databases

For professional legal work, **always cross-check with commercial legal databases** such as:

- IUS-INFO Croatia, Narodne novine premium services, CADIAL
...
- Croatian law changes continuously through new statutes, amendments, and court decisions
...
- Even "fresh" data may be outdated if recent amendments were published in Narodne novine
...
- A provision marked "in force" (na snazi) may have been:
  - Amended after the last database update
  - Repealed (ukinut) but not yet removed from the database
  - Subject to transitional rules affecting its applicability
  - Superseded by directly applicable EU regulations
...
1. **Complete case law** -- Coverage is limited; do not rely solely on this for sudska praksa research
...
5. **Full legislative history** -- Limited coverage of parliamentary debates (saborske rasprave) and explanatory memoranda
6. **EU law integration** -- Directly applicable EU regulations are not fully cross-referenced with Croatian implementing legislation
7. **Constitutional Court decisions** -- Limited coverage of Ustavni sud Republike Hrvatske case law
...
- **EU Law Blind Spots**: Cannot fully assess EU regulation compliance or CJEU case law impact
- **International Law Blind Spots**: Cannot fully assess international treaty obligations
...
This Tool is a **general-purpose AI system** under the EU AI Act. It is NOT a high-risk "administration of justice" system (which applies to AI used by courts and prosecutors for case outcomes). As Croatia is an EU Member State, the EU AI Act applies directly.
...
2. **Official Verification**: Cross-check ALL results with official sources (Narodne novine at nn.hr)
3. **EU Law Check**: Verify applicable EU regulations and directives via EUR-Lex
4. **Commercial Databases**: Use professional legal databases for authoritative, annotated versions
5. **Professional Judgment**: Apply independent legal analysis and professional judgment
6. **Document Sources**: Cite official sources in legal work, not this Tool
7. **Update Check**: Before finalizing legal work, check for recent amendments and decisions

## Changes to This Disclaimer

This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Croatian-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Croatian-law-mcp/issues
...
## Summary: What You Must Do / Sažetak
