/**
 * search_eu_implementations — Search EU directives/regulations referenced by Croatian legislation.
 */
...
export interface SearchEUImplementationsInput {
  ...
  year_from?: number;
  year_to?: number;
  has_croatian_implementation?: boolean;
  limit?: number;
}
...
export async function searchEUImplementations(
  ...
  if (input.has_croatian_implementation) {
    sql += ' HAVING croatian_statute_count > 0';
  }
