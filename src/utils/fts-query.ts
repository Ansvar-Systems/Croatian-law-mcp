/**
 * FTS5 query helpers for Croatian Law MCP.
 *
 * Handles query sanitization, boolean operator passthrough, and
 * variant generation for SQLite FTS5.
 */
 ...
 * Example: "kazneno gradjansko" -> "%kazneno%gradjansko%"
 */
